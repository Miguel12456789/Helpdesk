...
const detalhe = renderPage("detalhe")

module.exports = { home, base_gov, estatisticas_setor_publico, estatisticas_operadores_economicos, oportunidade_contratacao_publica, outros, detalhe };